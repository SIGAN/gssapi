...
namespace GSSAPI.Native
{
    public static class NativeMethods64
    {
        ...
        ///param3: gss_name_t*
        [DllImport("gssapi64.dll", EntryPoint = "gss_import_name")]
        ...
        ///param11: OM_uint32*
        ///param12: OM_uint32*
        [DllImport("gssapi64.dll", EntryPoint = "gss_init_sec_context")]
        ...
        ///param0: OM_uint32*
        ///param1: gss_buffer_t->gss_buffer_desc_struct*
        [DllImport("gssapi64.dll", EntryPoint = "gss_release_buffer")]
